				...
				if (entityiterator instanceof LogSplinterEntity) {
					...
					if (!(foundPlayer == null)) {
						...
						if (isWatched == true) {
							...
							if ((entityiterator instanceof LogSplinterEntity _datEntI ? _datEntI.getEntityData().get(LogSplinterEntity.DATA_frozenByRose) : 0) == 1) {
						...
						} else if (isWatched == false && (entityiterator instanceof LogSplinterEntity _datEntI ? _datEntI.getEntityData().get(LogSplinterEntity.DATA_frozenByRose) : 0) == 0) {
							...
							if (entityiterator.level()
								...
								if (entityiterator instanceof LogSplinterEntity _datEntSetI)
									_datEntSetI.getEntityData().set(LogSplinterEntity.DATA_mineProgress, (int) ((entityiterator instanceof LogSplinterEntity _datEntI ? _datEntI.getEntityData().get(LogSplinterEntity.DATA_mineProgress) : 0) + 1));
								if (entityiterator instanceof LogSplinterEntity _datEntSetI)
									_datEntSetI.getEntityData().set(LogSplinterEntity.DATA_mineX, entityiterator.level().clip(
											new ClipContext(entityiterator.getEyePosition(1f), entityiterator.getEyePosition(1f).add(entityiterator.getViewVector(1f).scale(3)), ClipContext.Block.COLLIDER, ClipContext.Fluid.NONE, entityiterator))
											.getBlockPos().getX());
								if (entityiterator instanceof LogSplinterEntity _datEntSetI)
							...
							if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == TheBackwoodsModBlocks.ASH_ROSE.get().asItem()
								...
								found = true;
								entityiterator.setDeltaMovement(new Vec3(0, 0, 0));
								if (entityiterator instanceof LivingEntity _livingEntity101 && _livingEntity101.getAttributes().hasAttribute(Attributes.MOVEMENT_SPEED))
									_livingEntity101.getAttribute(Attributes.MOVEMENT_SPEED).setBaseValue(0);
								if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == TheBackwoodsModBlocks.ASH_ROSE.get().asItem()) {
									{
									...
									if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getOrDefault(DataComponents.CUSTOM_DATA, CustomData.EMPTY).copyTag().getDouble("wilt_timer") > 750) {
										if (world instanceof Level _level) {
								...
								if ((entity instanceof LivingEntity _livEnt ? _livEnt.getOffhandItem() : ItemStack.EMPTY).getItem() == TheBackwoodsModBlocks.ASH_ROSE.get().asItem()) {
									...
									if ((entity instanceof LivingEntity _livEnt ? _livEnt.getOffhandItem() : ItemStack.EMPTY).getOrDefault(DataComponents.CUSTOM_DATA, CustomData.EMPTY).copyTag().getDouble("wilt_timer") > 750) {
										if (world instanceof Level _level) {
											if (!_level.isClientSide()) {
												_level.playSound(null, BlockPos.containing(x, y, z), BuiltInRegistries.SOUND_EVENT.get(ResourceLocation.parse("block.fire.extinguish")), SoundSource.NEUTRAL, 1, 1);
											} else {
							...
							if (Math.random() < 0.2) {
								...
								if (found == true) {
									if (entityiterator instanceof LivingEntity _livingEntity133 && _livingEntity133.getAttributes().hasAttribute(Attributes.MOVEMENT_SPEED))
										_livingEntity133.getAttribute(Attributes.MOVEMENT_SPEED).setBaseValue(0);
									entityiterator.setDeltaMovement(new Vec3(0, 0, 0));
								}
							}
						} else if (found == true) {
							if (entityiterator instanceof LivingEntity _livingEntity135 && _livingEntity135.getAttributes().hasAttribute(Attributes.MOVEMENT_SPEED))
								_livingEntity135.getAttribute(Attributes.MOVEMENT_SPEED).setBaseValue(0);
							entityiterator.setDeltaMovement(new Vec3(0, 0, 0));
						}
					}
				}
