...
@EventBusSubscriber
public class PetrifiedWealdTorchFadeProcedure {

    // ---------- TUNABLE ----------
    private static final int CHECK_INTERVAL_TICKS = 10;
    private static final double DISAPPEAR_CHANCE = 0.07; // Slightly higher chance than Grain for more tension
    private static final double WATCH_DOT_THRESHOLD = 0.70;
    private static final int MAX_TRACKED_TORCHES = 256;
    // -----------------------------

    private static final String NBT_LIST_KEY = "petrified_tracked_torches";
    ...
    public static void onPlayerTick(PlayerTickEvent.Post event) {
        ...
        for (BlockPos pos : tracked) {
            ...
            if (!watched && Math.random() < DISAPPEAR_CHANCE) {
                ...
                // Optional: add a quiet "extinguish" sound here
                continue;
            }
